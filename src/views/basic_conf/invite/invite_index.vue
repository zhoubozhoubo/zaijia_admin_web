        ...
        <Card>
            ...
            <div>
                <Form ref="myForm" :rules="ruleValidate" :model="formItem" :label-width="80">
                    <FormItem label="邀请技巧" prop="step">
                        <Row v-for="(item, index) in formItem.step" :key="index" style="margin-bottom: 10px;">
                            <Col span="10">
                                <Input v-model="formItem.step[index]" :placeholder="'邀请技巧' + (index-0+1)"></Input>
                            </Col>
                        ...
                        <Row>
                            <Col span="4">
                                <Button type="primary" ghost icon="md-add" @click="addStep">添加技巧</Button>
                            </Col>
                        </Row>
                    </FormItem>
                    <div>
    ...
    export default {
        ...
        methods: {
            ...
            submit () {
                ...
                axios.post('BasicConf/saveInvite', vm.formItem).then(function (response) {
            ...
            init () {
                let vm = this;
                axios.get('BasicConf/invite').then(function (res) {
                    if (res.data.code === 1) {
