        ...
        <Row>
            ...
            <Card style="margin-bottom: 10px">
                <Form inline>
                        ...
                        <Input v-model="searchConf.status" placeholder="状态"></Input>
                    </FormItem>
                                        <FormItem style="margin-bottom: 0">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                columnsList:[{title:"轮播图id",key:"id",align:"center"},{title:"轮播图名称",key:"name",align:"center"},{title:"轮播图图片",key:"img",align:"center"},{title:"轮播图跳转地址",key:"url",align:"center"},{title:"排序",key:"sort",align:"center"},{title:"状态",key:"status",align:"center"},{title:"操作",key:"handle",align:"center",handle:["edit","delete"]}],
                tableData: [],
                tableShow: {
                    currentPage: 1,
                    pageSize: 10,
                ...
                ruleValidate: {id:[{required:0,message:"",trigger:"blur"}],img:[{required:true,message:"请上传图片",trigger:"blur"}]},
                    loading: true,
            }
        },
        created() {
            this.init()
            this.getList()
                            // this.uploadUrl = this.HttpUpload+'/admin/Index/upload';
