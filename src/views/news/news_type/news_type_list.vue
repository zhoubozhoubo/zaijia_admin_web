...
<script>
    ...
    export default {
        ...
        data() {
            return {
                columnsList:[{title:"新闻类型id",key:"news_type_id",align:"center"},{title:"类型名称",key:"name",align:"center"},{title:"类型图片",key:"img",align:"center"},{title:"类型描述",key:"comment",align:"center"},{title:"排序",key:"sort",align:"center"},{title:"状态",key:"status",align:"center"},{title:"操作",key:"handle",align:"center",handle:["edit","delete"]}],
                tableData: [],
                tableShow: {
                    currentPage: 1,
                    pageSize: 10,
                ...
                uploadHeader: {},
                                    ...
                                    ruleValidate: {news_type_id:[{required:0,message:"",trigger:"blur"}],name:[{required:true,message:"请输入类型名称",trigger:"blur"}],img:[{required:true,message:"请上传图片",trigger:"blur"}]},
                                    loading: true,
            }
        },
        created() {
                                ...
                                return h('i-switch', {
                                    ...
                                    on: {
                                        'on-change': function (status) {
                                            change({news_type_id:currentRowData.news_type_id,status:status}).then(res => {
                                                vm.$Message.success(res.data.msg)
                                                vm.cancel()
                                            }, err => {
                                                vm.$Message.error(res.data.msg)
